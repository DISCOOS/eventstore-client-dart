...
class AllStreamPosition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AllStreamPosition',
          package: const $pb.PackageName(
              const $core.bool.fromEnvironment('protobuf.omit_message_names')
                  ? ''
                  : 'event_store.client'),
...
class WrongExpectedVersion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..oo(0, [1, 2])
    ..oo(1, [3, 4, 5, 6])
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentStreamRevision', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$9.Empty>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentNoStream',
        subBuilder: $9.Empty.create)
    ..a<$fixnum.Int64>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expectedStreamPosition', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$9.Empty>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expectedAny', subBuilder: $9.Empty.create)
    ..aOM<$9.Empty>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expectedStreamExists', subBuilder: $9.Empty.create)
    ..aOM<$9.Empty>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expectedNoStream', subBuilder: $9.Empty.create)
    ..hasRequiredFields = false;
